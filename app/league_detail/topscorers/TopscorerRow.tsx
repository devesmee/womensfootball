  ...
  return (
    <View style={topscorerListStyles.row}>
        <View style={topscorerListStyles.photoNameRow}>
            <Image src={topscorer.player.photo} style={topscorerListStyles.playerPhoto}></Image>
            ...
            <View style={topscorerListStyles.playerNameTeamColumn}>
                ...
                <Image src={topscorer.statistics[0].team.logo} style={topscorerListStyles.teamLogo}></Image>
                <Text style={topscorerListStyles.teamName}>{topscorer.statistics[0].team.name}</Text>
                </View>
            </View>
        </View>
        <View style={topscorerListStyles.goalsRow}>
            <Text style={sharedStyles.defaultText}>{topscorer.statistics[0].goals.total} goals</Text>
        </View>
    </View>
  );
}
